...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url('/css/jumbotron.css');?>">
    </head>
    <body>
        ...
        <div class="jumbotron" style="background-image: url('../../images/STB13_Ken_06.png');">
            <div class="container">
                ...
                <h2>Build, deploy and scale applications faster</h2> 
                <br/>  
                <p class="lead">
            ...
            <div class="row flex text-center">
                ...
                <div class="col-md-3 col-sm-6 hero-feature">
                    <div class="card">
                        ...
                        <div class="caption">
                            <h4 class="card-title">Bring your own Docker Container</h4>
                        </div>
                        <br/>
                        <div class="card-text" style="text-align:left">
                            <ul >
                ...
                <div class="col-md-3 col-sm-6 hero-feature">
                    <div class="card">
                        ...
                        <div class="caption">
                            <h4 class="card-title">Use Built-in images</h4>
                        </div>
                        <div class="card-text" style="text-align:left">
                            <ul>
                ...
                <div class="col-md-3 col-sm-6 hero-feature">
                    <div class="card">
                        ...
                        <div class="caption">
                            <h4 class="card-title">Samples and Resources</h4>
                        </div>
                        <div class="card-text" style="text-align:left">
                            <ul>
